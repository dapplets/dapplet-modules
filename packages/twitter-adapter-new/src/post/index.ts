    ...
    if (this.insPointName === 'PROFILE') {
      return html`<div class="post">
        ...
        <div class="text-container">
          <div>
            <span class="${this.theme === 'DARK' ? 'text-dark-name' : 'text-light-name'}"
              >${this.authorFullname}</span
            >
            <span> </span>
            <span class="${this.theme === 'DARK' ? 'text-dark-user-name' : 'text-light-user-name'}"
              >@${this.authorUsername}</span
            >
